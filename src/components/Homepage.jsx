        ...
        >
          ...
          >
            ...
            <Text
              ...
              fontWeight={400}
            >
              ESA is the Enterprise Software and  Applications unit of Business Blueprint Technology(BBT)
            </Text>
            <Flex
              gap={{ base: "20px", md: "0" }}
              w="70%"
            ...
            >
              ...
              <Button
                ...
                onClick={() =>
                  window.open("http://blueprintnet.com/", "_blank")
                }
              >
                Visit BBT's Site
              </Button>
                ...
                {({ isExpanded }) => (
                  <>
                    <AccordionButton _focus={{ outline: "none" }}>
                      ...
                      {isExpanded ? (
                        <MinusIcon ml={2} fontSize="12px" />
                      ) : (
                        <AddIcon ml={2} fontSize="12px" />
                      )}
                    </AccordionButton>
                    <AccordionPanel textAlign="left" pb={6}>
